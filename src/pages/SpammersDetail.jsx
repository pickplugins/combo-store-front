...
function SpammersDetail() {
	...
	var columns = {
		...
		email: { label: t("Email"), classes: 'w-80' },
		report_count: { label: t("Report Count"), order: 'DESC', classes: 'w-50' },
		level: { label: t("Level"), order: 'DESC', classes: 'w-30' },
